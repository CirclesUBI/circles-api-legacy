 ...
 * @apiSuccess (Success 200) {String} category The category of item offered.
 ...
 * @apiSuccess (Success 200) {String} owner_id User Id of the Offer owner.
...
/**
 * @api {get} /offers/:offerId Request Offer by Id
 * @apiName GetOffer
 * @apiGroup Offers
 * @apiVersion 1.1.2
 * @apiPermission user, admin
 ...
 * @apiSuccess (Success 201) {String} category The category of item offered.
 ...
 * @apiSuccess (Success 201) {String} owner_id User Id of the Offer owner.
